...
\address{(919)-457-2034 \\ \url{http://jianfeng.us}   \\ \href{mailto:jchen37@ncsu.edu}{jchen37@ncsu.edu}
}
...
%-------------------------------------------------- 
% \begin{rSubsection}{(Research Assistant) Sampling vs. Searching in Search-based SE}{Dec 2014 - Present}
% {North Carolina State University}{}
...
% \vspace{0.5em}~\\
% \textbf{\it Skills: MPI, SBSE, Software Architecture Analysis, Z3 Solver}
% \end{rSubsection}
